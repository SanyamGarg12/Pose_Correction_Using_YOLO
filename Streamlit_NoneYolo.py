    ...
    try:
        if results_yolo is not None:
            ...
            if results_pose.pose_landmarks is not None:
                ...
                left_elbow_angle_display.text(f"Left Elbow Angle: {left_elbow_angle:.2f} deg")
                right_elbow_angle_display.text(f"Right Elbow Angle: {right_elbow_angle:.2f} deg")
                left_hip_angle_display.text(f"Left Hip Angle: {left_hip_angle:.2f} deg")
                right_hip_angle_display.text(f"Right Hip Angle: {right_hip_angle:.2f} deg")
                left_knee_angle_display.text(f"Left Knee Angle: {left_knee_angle:.2f} deg")
                right_knee_angle_display.text(f"Right Knee Angle: {right_knee_angle:.2f} deg")
                left_ankle_angle_display.text(f"Left Ankle Angle: {left_ankle_angle:.2f} deg")
                right_ankle_angle_display.text(f"Right Ankle Angle: {right_ankle_angle:.2f} deg")
